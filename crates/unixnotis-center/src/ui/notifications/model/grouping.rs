...
impl NotificationList {
    ...
    pub(in crate::ui::notifications) fn normalize_group_key<'a>(
        &self,
        key: &'a str,
    ) -> Cow<'a, str> {
    ...
    pub(in crate::ui::notifications) fn expected_list_len(&self) -> usize {
    ...
    pub(in crate::ui::notifications) fn group_has_visible_entries(&self, ids: &[u32]) -> bool {
    ...
    pub(in crate::ui::notifications) fn visible_ids_for_group<'a>(
        &self,
        ids: &'a [u32],
    ) -> Cow<'a, [u32]> {
        if self.filter_query.is_none() {
    ...
    pub(in crate::ui::notifications) fn normalize_filter_query(
        &self,
        query: &str,
    ) -> Option<FilterQuery> {
