...
impl NotificationList {
    pub(in crate::ui::notifications) fn clear_group_indices(&mut self) {
    ...
    pub(in crate::ui::notifications) fn index_insert_front(
        &mut self,
        key: &Rc<str>,
        id: u32,
        is_active: bool,
    ...
    pub(in crate::ui::notifications) fn index_remove(
        &mut self,
        key: &Rc<str>,
        id: u32,
        was_active: bool,
    ...
    pub(in crate::ui::notifications) fn index_move_to_front(
        &mut self,
        key: &Rc<str>,
        id: u32,
        is_active: bool,
