...
use super::{config, icons, list, media_widget, panel, widgets};
...
pub struct UiState {
    ...
    // Deduplication keeps repeated watcher events from reopening one dismissed notice
    pub(super) last_reload_notice: Option<config::ReloadNoticeFingerprint>,
