...
pub(in crate::ui::widgets::command_runtime::command) fn build_command_runtime() -> Option<Runtime> {
...
pub(in crate::ui::widgets::command_runtime::command) fn run_command_with_timeout(
    cmd: &CommandSpec,
    timeout: Duration,
