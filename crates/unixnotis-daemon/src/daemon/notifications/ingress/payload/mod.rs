...
pub(in crate::daemon::notifications) use visuals::{
    materialize_sender_visual, may_materialize_content_image, sender_visual_path_allowed,
    sender_visual_role, SenderVisualRole, CONVERSATION_AVATAR_TIMEOUT, MAX_STORED_AVATAR_DIMENSION,
